      ...
      <div className={'flex flex-col py-[40px] px-[20px] max-w-[450px] md:shadow border border-[#ffffff14] rounded-[12px] items-center gap-[20px]'}>
        ...
        <div className={'px-[20px] py-[32px] w-full rounded-[12px] bg-[#1F2329] text-[#F9F9F9] mt-[20px]'}>
          <p className={'font-bold'}>
            It will allow the NESTFi Test bot view your address, account balance and position information.
          </p>
          <br/>
          <p className={'text-sm'}>
            Please make sure your are using the official NESTFi Test bot. <a href={'https://t.me/NESTFiTestBot'} target={'_blank'} className={'text-[#EAAA00]'}>
            @NESTFiTestBot
          </a>
          </p>
        </div>
